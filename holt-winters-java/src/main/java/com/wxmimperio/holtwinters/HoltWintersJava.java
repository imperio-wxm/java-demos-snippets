 ...
 * @author weiximing
 * @version 1.0.0
 * @className HoltWinters.java
 * @description This is the description of HoltWinters.java
 * @createTime 2021-01-11 21:05:00
 * <p>
...
public class HoltWintersJava {
     ...
     *
     */
    public static double[] forecast(Double[] y, double alpha, double beta, double gamma, int period, int m, boolean debug) {
    ...
    public static double[] forecast(Double[] y, double alpha, double beta, double gamma, int period, int m) {
     ...
     * @param m
     */
    private static void validateArguments(Double[] y, double alpha, double beta, double gamma, int period, int m) {
        if (y == null) {
     ...
     */
    private static double[] calculateHoltWinters(Double[] y, double a0, double b0, double alpha, double beta, double gamma, double[] initialSeasonalIndices, int period, int m, boolean debug) {
