...
public class ConsumerMain {
    public static void main(String args[]) {
        ...
        //topicList1.add("meiyu_user_active");
        //topicList1.add("meiyu_user_reg");
        //topicList1.add("test_1");
        //topicList1.add("meiyu_user_login");
        //topicList1.add("pt_game_login");
        //topicList1.add("meiyu_user_deposit");
        topicList1.add("pt_game_deposit");
