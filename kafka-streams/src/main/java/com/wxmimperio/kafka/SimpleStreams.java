...
public class SimpleStreams {
    ...
    public static void main(String[] args) {
        ...
        streamsConfiguration.put(StreamsConfig.ZOOKEEPER_CONNECT_CONFIG, "192.168.1.112:2181");
        ...
        streamsConfiguration.put(StreamsConfig.VALUE_SERDE_CLASS_DOC, StringSerializer.class);
        ...
        builder.addSource("SOURCE", "simple-topic")
                ...
                .addSink("SINK1", "sink-topic1", "PROCESS3");
