...
public class ChildOneProcessor implements Processor<byte[], byte[]>, ProcessorSupplier {
    ...
    public void process(byte[] key, byte[] value) {
        ...
        System.out.println("ChildOneProcessor ===== " + messageValue);
