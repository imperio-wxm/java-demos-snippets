...
public class ZipkinConfig extends WebMvcConfigurerAdapter {
     ...
     */
    @Bean
    Sender sender(@Value("zipkin-service2") String serverName) {
     ...
     */
    @Bean
    AsyncReporter<Span> spanReporter(@Value("zipkin-service2") String serverName) {
     ...
     */
    @Bean
    Tracing tracing(@Value("zipkin-service2") String serviceName, @Value("http://127.0.0.1:9411/api/v2/spans") String serverName) {
